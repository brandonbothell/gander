...
export const SearchTools = forwardRef<HTMLDivElement, SearchToolsProps>(
  (
    ...
    const [dateInputTimeouts, setDateInputTimeouts] = useState<{
      [key: string]: number
    }>({})

    // Add this state to SearchTools component:
    const [blockFilterUpdates, setBlockFilterUpdates] = useState<{
      [key: string]: boolean
    }>({ from: false, to: false })
    ...
    useEffect(() => {
      const anyBlocked = Object.values(blockFilterUpdates).some(
        (blocked) => blocked,
      )
    ...
    const handleInputBlur = (e: React.FocusEvent<HTMLInputElement>) => {
      ...
      if (
        relatedTarget?.closest('.searchtools-popout') ||
    ...
    return (
      ...
      >
        ...
        {searchInputActive && <div style={{ height: 48, width: '100%' }} />}
        ...
        >
          ...
          >
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              ...
              <path
                d="M10 6v2M10 12v2M6 10h2M12 10h2"
                stroke="#fff"
                strokeWidth="2"
                strokeLinecap="round"
              />

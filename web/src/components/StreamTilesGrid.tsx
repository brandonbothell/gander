          ...
          <div className="stream-tile">
            ...
            {motionSaving[stream.id] ? (
              ...
              <>
                ...
                >
                  {motionStatus[stream.id]?.secondsLeft
                    ? `${motionStatus[stream.id].secondsLeft}s`
                    : ''}
                </span>
                <div
            ...
            {stream.id === activeStreamId && onDeleteStream && (
              <button
                ...
                style={{
                  ...
                  fontWeight: 'bold',
                  cursor:
                    deletingStreamId === stream.id ? 'not-allowed' : 'pointer',
            ...
            />
            <div
              className="stream-tile-overlay"
              style={{
                padding: '1.5rem 1.2rem 1.2rem 1.2rem',
                background:
                  'linear-gradient(to bottom, rgba(20,30,60,0.1) 0%, rgba(20,30,60,0.5) 30%, rgba(20,30,60,0.85) 100%)',
              }}
            >
              <div className="stream-tile-title">
                {stream.nickname || stream.id}
              </div>
              <button
                onClick={(e) => {
                  e.stopPropagation()

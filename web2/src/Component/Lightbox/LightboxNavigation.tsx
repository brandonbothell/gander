...
export interface LightboxNavigationProps
  extends
    BoxProps,
    CompoundStylesApiProps<LightboxNavigationFactory>,
    ElementProps<'div'> {}
...
export const LightboxNavigation = factory<LightboxNavigationFactory>(
  (props) => {
    ...
    const fallbackCanPrev = ctx.loop
      ? ctx.slides.length > 1
      : ctx.currentIndex > 0
